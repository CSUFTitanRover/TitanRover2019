...
def getFeedback():
    ...
    while True:
        feed = ser2.read(12)
        print(feed[:3], feed[4:7], feed[8:])


if __name__ == "__main__":
    ser = serial.Serial("/dev/serial/by-id/usb-Silicon_Labs_RoverUART_0001-if00-port0", baudrate=115200)
    ser2 = serial.Serial("/dev/serial/by-id/usb-Silicon_Labs_CP2102_USB_to_UART_Bridge_Controller_0001-$
