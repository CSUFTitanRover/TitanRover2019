...
class Menu():
    ...
    def __init__(self, screen, start_x, app_title):
        ...
        self.yaw_title_str = "Vehicle Yaw:"
        self.dest_title_str = "Add new hint:"
        self.screen = screen
    ...
    def blitme(self, yaw, new_destination):
        ...
        self.dest_title.blitme(self.dest_title_str)
    ...
    def build_info_displays(self): # Things that display values
        ...
        self.nav_text = Text.YawText(self.screen,str(0),color_text,color_background,20,self.start_x,None,self.screen.get_rect().top+75,None) # Shows the yaw value
        ...
        self.dest_title = Text.Text(self.screen,self.dest_title_str,color_text,color_background,15,self.start_x,None,self.screen.get_rect().top+425,None)
