...
(cl:defmethod cl:initialize-instance :after ((m <Arm>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Arm)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name mobility_topic-msg:<Arm> is deprecated: use mobility_topic-msg:Arm instead.")))

(cl:ensure-generic-function 'J1-val :lambda-list '(m))
(cl:defmethod J1-val ((m <Arm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobility_topic-msg:J1-val is deprecated.  Use mobility_topic-msg:J1 instead.")
  (J1 m))

(cl:ensure-generic-function 'J2-val :lambda-list '(m))
(cl:defmethod J2-val ((m <Arm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobility_topic-msg:J2-val is deprecated.  Use mobility_topic-msg:J2 instead.")
  (J2 m))

(cl:ensure-generic-function 'J3-val :lambda-list '(m))
(cl:defmethod J3-val ((m <Arm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobility_topic-msg:J3-val is deprecated.  Use mobility_topic-msg:J3 instead.")
  (J3 m))

(cl:ensure-generic-function 'J4-val :lambda-list '(m))
(cl:defmethod J4-val ((m <Arm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobility_topic-msg:J4-val is deprecated.  Use mobility_topic-msg:J4 instead.")
  (J4 m))

(cl:ensure-generic-function 'J51-val :lambda-list '(m))
(cl:defmethod J51-val ((m <Arm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobility_topic-msg:J51-val is deprecated.  Use mobility_topic-msg:J51 instead.")
  (J51 m))

(cl:ensure-generic-function 'J52-val :lambda-list '(m))
(cl:defmethod J52-val ((m <Arm>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader mobility_topic-msg:J52-val is deprecated.  Use mobility_topic-msg:J52 instead.")
  (J52 m))
