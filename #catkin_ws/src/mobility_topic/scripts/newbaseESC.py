...
Description: Mobility script reads in a text file with configuration for various controllers. User acti$
             are interpreted by pygame and mapped to rover Actions for wheel and arm control. Communica$
             these values is handled by a separate classes.

             To start program with a different configuration than rumblepad, list .txt file after scrip$
