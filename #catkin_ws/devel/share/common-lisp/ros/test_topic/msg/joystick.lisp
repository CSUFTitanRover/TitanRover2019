...
(cl:defclass <joystick> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (mobility
    :reader mobility
    :initarg :mobility
    :type test_topic-msg:Mobility
    :initform (cl:make-instance 'test_topic-msg:Mobility))
   (arm
    :reader arm
    :initarg :arm
    :type test_topic-msg:Arm
    :initform (cl:make-instance 'test_topic-msg:Arm))
   (mode
    :reader mode
    :initarg :mode
    :type test_topic-msg:Mode
    :initform (cl:make-instance 'test_topic-msg:Mode)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <joystick>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'joystick)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_topic-msg:<joystick> is deprecated: use test_topic-msg:joystick instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <joystick>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_topic-msg:header-val is deprecated.  Use test_topic-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'mobility-val :lambda-list '(m))
(cl:defmethod mobility-val ((m <joystick>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_topic-msg:mobility-val is deprecated.  Use test_topic-msg:mobility instead.")
  (mobility m))

(cl:ensure-generic-function 'arm-val :lambda-list '(m))
(cl:defmethod arm-val ((m <joystick>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_topic-msg:arm-val is deprecated.  Use test_topic-msg:arm instead.")
  (arm m))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <joystick>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_topic-msg:mode-val is deprecated.  Use test_topic-msg:mode instead.")
  (mode m))
