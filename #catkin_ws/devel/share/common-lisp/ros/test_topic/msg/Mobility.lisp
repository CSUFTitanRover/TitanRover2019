...
(cl:defmethod cl:initialize-instance :after ((m <Mobility>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Mobility)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name test_topic-msg:<Mobility> is deprecated: use test_topic-msg:Mobility instead.")))

(cl:ensure-generic-function 'ForwardY-val :lambda-list '(m))
(cl:defmethod ForwardY-val ((m <Mobility>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_topic-msg:ForwardY-val is deprecated.  Use test_topic-msg:ForwardY instead.")
  (ForwardY m))

(cl:ensure-generic-function 'TurningX-val :lambda-list '(m))
(cl:defmethod TurningX-val ((m <Mobility>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader test_topic-msg:TurningX-val is deprecated.  Use test_topic-msg:TurningX instead.")
  (TurningX m))
